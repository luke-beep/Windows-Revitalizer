...
{
    internal class TCPIPOn : ICommand
    {
        public void Execute()
        {
            ExecuteBatchFromWebHelper executeBatchFromWeb = new ExecuteBatchFromWebHelper();
            executeBatchFromWeb.ExecuteBatchScriptFromWeb("https://raw.githubusercontent.com/luke-beep/Windows-Revitalizer/main/Resources/TCPIPOn.bat");
        }
    }
}
