...
{
    internal class EnableHDCP : ICommand
    {
        public void Execute() 
        {
            ...
            if (NVIDIA)
            {
                executeBatchFromWebHelper.ExecuteBatchScriptFromWeb("https://raw.githubusercontent.com/luke-beep/Windows-Revitalizer/main/Resources/EnableHDCP.bat");
            }
        }
    }
}
